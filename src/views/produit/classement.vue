  ...
  export default {
    ...
    methods: {
      ...
      listeProduit() {
        ...
        this.$http.get(`${this.callback}/statistic/classement/typeCarnetsByBestSell`, headers).then(
          (response) => {
            ...
            for (let i = 0; i < data.length; i++) {
              this.data.push({
                ...
                libelle: data[i]._id.libelle,
                montant: data[i]._id.montant,
                vendus: data[i].totalCarnetVendu
              });
            }
          },
          (response) => {
