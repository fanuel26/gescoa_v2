            ...
            <div style="display: flex; align-items: center; justify-content: space-between;">
              ...
              <div>
                <!-- <router-link type="primary" :to="{ name: 'Client_not_visite' }"
                  ...
                  ></router-link
                > -->
                <router-link type="primary" :to="{ name: 'Client_classement' }"><a-button class="mx-2">Classement
                    clients</a-button></router-link>
          ...
          <a-table :columns="columns" :data-source="data" :pagination="true">
            <template slot="operation" slot-scope="text, record">
              <div style="display: flex;">
                ...
                <router-link :to="{ name: 'Carnets_by_client', params: { id: record.key } }"><a-button type="primary"
                    size="small" style="margin-left: 10px;">Liste carnet</a-button></router-link>
              </div>
            </template>
          </a-table>
