    ...
    <a-row :gutter="24">
      <a-col :span="12" :lg="12" :xl="24" class="mb-24">
        <a-card class="card card-body border-0">
          ...
          <div
            class="mb-4 d-flex justify-content-start align-items-center"
            v-if="is_state == true"
          >
            <a-form-item
              class="mx-2"
          ...
          <a-table :columns="columns" :data-source="data" :pagination="true">
            <template slot="etat" slot-scope="text, record">
              <span v-if="record.etat == true" class="text-success"
                >Online</span
              >
              <span v-if="record.etat == false" class="text-danger"
                >Offline</span
              >
            </template>
          </a-table>
...
export default {
  ...
  methods: {
      ...
      this.$http
        ...
        .then(
          (response) => {
            ...
            this.stats[0].value =
              response.body.topCollecteurByCarnetSell.length;
    ...
    nbClassementByCotisation() {
      ...
      this.is_state = true;
      this.data_g.sort((a, b) => b.total_cotisation - a.total_cotisation);
    ...
    nbClassementByCarnet() {
      ...
      this.is_state = true;
      this.data_g.sort((a, b) => b.carnet_vendu - a.carnet_vendu);
      console.log(this.data_g);
      let data = this.data_g;
      this.data = [];
      for (let i = 0; i < data.length; i++) {
