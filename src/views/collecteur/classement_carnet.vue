                            ...
                            <a-row type="flex" :gutter="24">
                                ...
                                <a-col :span="24" :md="24" class="">
                                    <a-form-item label="Produits">
                                        <a-select mode="multiple" v-model="produit"
                                            search-placeholder="Selectionnez le produit" :options="produitData">
                                            <!-- <a-select-option
                        ...
                        {{ dt.title }}
                                ...
                                <a-col :span="8" :md="8" class="">
                                    <a-form-item class="" label="Mise du jour (Fcfa)" :colon="false">
                                        ...
                                        ]" v-model="prix_w" @change="calcule_total" type="number"
                    ...
                    <a-table :columns="columns" :data-source="data">
                        <template slot="operation" slot-scope="text, record">
                            <div class="d-flex">
                                ...
                                <a-popconfirm v-if="record.status == 1" title="Sûre de descactiver?"
                                    cancel-text="annuler" ok-text="Valider" @confirm="() => block(record.key)">
                                    <a-button type="danger" class="mx-2" size="small">Descactiver</a-button>
                                </a-popconfirm>

                                <a-popconfirm v-if="record.status == 0" title="Sûre d'activé?" cancel-text="annuler"
                                    ok-text="Valider" @confirm="() => block(record.key)">
                                    <a-button type="success" class="mx-2" size="small">Activé</a-button>
                                </a-popconfirm>
                            </div>
                        </template>
                    </a-table>
...
export default {
    ...
    methods: {
        ...
        listeCarnet() {
            ...
            this.$http
                .post(`${this.callback}/v2/classement/carnet/by-collector/${this.$route.params.id}?all=true`, {}, headers)
                .then(
                    (response) => {
                        let data = response.body.data;
